...
| Built-in | Inputs | Description |
| ------- |--------|-------------|
| <span class="opa-keep-it-together">``base64url_encode(x, output)``</span> | 1 | ``output`` is ``x`` serialized to a base64url encoded string |
| <span class="opa-keep-it-together">``base64url_decode(string, output)``</span> | 1 | ``output`` is ``string`` deserialized from a base64url encoding to a string |
